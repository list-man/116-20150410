...
-(RenderScene*) initWithContext:(EAGLContext *)_context
{
    ...
    _116TextDrawelement * projectitem = [[_116TextDrawelement alloc]initWithText:curproj.projectName ElementRect:CGRectMake(0, 0, 300, 600) TextRect:CGRectMake(50, 180, 200, 200) UIFont:[UIFont italicSystemFontOfSize:80] TextureNumStart:0 Program:_program Matrix:GLKMatrix4Identity];
